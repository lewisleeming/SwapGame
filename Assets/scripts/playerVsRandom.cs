...
public class playerVsRandom : randomScript2
{
    ...
    public void PlayerTwoTurn()
    {
        if (state == gameState.PLAYERTWO)
        {
            ...
            checkFinished(pass, playerTwo.GameOver);
            enabled = true;
        }
    }
    ...
    private void tileCheck(float distance)
    {
        ...
        else if (mousePos.y == firstPos.y || mousePos.x == firstPos.x)
        {
            ...
            {
                case 0:
                    if ((state == gameState.PLAYERONE && blueTiles[1] <= 0) ||
                        (state == gameState.PLAYERTWO && redTiles[1] <= 0))
                    {
                        Destroy(line);
                        turnTaken = false;
                    }
                    ...
                    break;
                case 1:
                    if ((state == gameState.PLAYERONE && blueTiles[2] <= 0) ||
                        (state == gameState.PLAYERTWO && redTiles[2] <= 0))
                    {
                        Destroy(line);
                        turnTaken = false;
                    }
                    ...
                    break;
                case 2:
                    if ((state == gameState.PLAYERONE && blueTiles[3] <= 0) ||
                        (state == gameState.PLAYERTWO && redTiles[3] <= 0))
                    {
                        Destroy(line);
                        turnTaken = false;
                    }
                ...
                case 3:
                    if ((state == gameState.PLAYERONE && blueTiles[4] <= 0) ||
                        (state == gameState.PLAYERTWO && redTiles[4] <= 0))
                    {
                        Destroy(line);
                        turnTaken = false;
                    }
